  ...
  return (
    <div className="relative flex h-full flex-col gap-[24px] overflow-hidden rounded-[32px] px-[16px] py-[32px] md:gap-[32px] md:rounded-[48px] md:px-[24px] md:py-[48px] xl:flex-1">
      ...
      {popular && popularLabel && (
        <div className="absolute right-0 top-0 z-10 flex h-[36px] items-center justify-center rounded-bl-[3000px] rounded-tl-[3000px] bg-primary px-[24px] py-[2px]">
          <span className="text-[14px] leading-[1.4] text-surface">
            {popularLabel}
          </span>
        </div>
      )}
      ...
      <div className="relative flex flex-col gap-[32px]">
        ...
        <div className="flex flex-col gap-[8px]">
          <h3 className="whitespace-pre-line text-[24px] font-bold leading-[1.1] text-text-primary md:text-[32px]">
            {title}
          </h3>
          <p className="whitespace-pre-line text-[16px] leading-[1.4] text-text-primary md:text-[18px]">
            {desc}
          </p>
        </div>
      </div>
      ...
      <div className="relative flex items-end gap-[2px]">
        <span className="text-[40px] font-bold leading-[1.1] text-text-primary md:text-[54px]">
          {price}
        </span>
        <span className="text-[20px] font-bold leading-[1.1] text-text-body md:text-[24px]">
          {period}
        </span>
      </div>
